...
public function studentannouncements()
			{
				...
				<strong>Success !</strong> Successfully Inserted .
					...
					redirect('PgMswAided/studentannouncements', 'refresh');
				}
		
				$this->load->view('template/pgmswaided/header');
				$this->load->view('template/pgmswaided/menubar');
				$this->load->view('template/pgmswaided/headerbar');
				$this->load->view('pgmswaided/announcements',$data);
				$this->load->view('template/pgmswaided/footer');
			}
 ...
 */
       ...
       $this->load->view("template/pgmswaided/header");
        $this->load->view("template/pgmswaided/menubar");
        $this->load->view("template/pgmswaided/headerbar");
        $this->load->view("pgmswaided/principal_approved_list", $data);
        $this->load->view("template/pgmswaided/footer", $data); 
    }
    ...
    <strong>Success !</strong> Admitted Successfully .
        ...
        redirect('PgMswAided/principalApproved/'); 
	...
	public function registerNumberFormat(){
        ...
        <strong>Success !</strong>Updated Successfully .
            ...
            redirect('PgMswAided/admittedStudent/'); 
	...
	public function admittedStudent(){
        ...
        $this->load->view("template/pgmswaided/menubar");
        $this->load->view("template/pgmswaided/headerbar");
        $this->load->view("pgmswaided/admittedStudent", $data);
        $this->load->view("template/pgmswaided/footer");
		...
		$this->load->view("template/pgmswaided/menubar");
		$this->load->view("template/pgmswaided/headerbar");
		$this->load->view("pgmswaided/admittederp", $data);
		$this->load->view("template/pgmswaided/footer"); 
...
->where('shotlisted_candidate.created <',$this->eyear.'-06-01')
        ...
        <strong>Success !</strong> Deleted Successfully !
                    ...
                    redirect("PgMswAided/SelectionStatus", "refresh"); 
	...
	public function stuWOZoom()
    {
        ...
        $this->load->view("template/pgmswaided/menubar");
        $this->load->view("template/pgmswaided/headerbar");
        $this->load->view("pgmswaided/stuWOZoom", $data);
        $this->load->view("template/pgmswaided/footer");
    }
	...
	public function allotPanel()
    {
        ...
        $this->load->view("template/pgmswaided/menubar");
        $this->load->view("template/pgmswaided/headerbar");
        $this->load->view("pgmswaided/allotPanel", $data);
        $this->load->view("template/pgmswaided/footer");
    }
	   ...
	   public function createPanel()
    {
        ...
        if (isset($_POST["submit"])) {
			...
			redirect('pgMswAided/createPanel','refresh');	
			}
		}
        ...
        $this->load->view("template/pgmswaided/menubar");
        $this->load->view("template/pgmswaided/headerbar");
        $this->load->view("pgmswaided/createPanel", $data);
        $this->load->view("template/pgmswaided/footer");
    }
