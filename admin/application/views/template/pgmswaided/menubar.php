   ...
   <li><a href="<?=site_url()?>PgMswAided" class="waves-effect"><i class="icon-home"></i><span>Dashboard</span></a></li>
  ...
  <li><a href="<?=site_url()?>PgMswAided/studentApplied" class="waves-effect"><i class="fa fa-circle-o text-red"></i><span>Application Details </span></a></li>
  ...
  <!--<li><a href="<?=site_url()?>/Admin/userApplied" class="waves-effect"><i class="fa fa-circle-o text-red"></i><span>New Applications</span></a></li>
	  ...
	  <li>
        ...
        <ul class="sidebar-submenu">
  		  ...
  		  <li><a href="<?=site_url()?>PgMswAided/stuCmnty"><i class="fa fa-circle-o"></i> Allot Zoom Link</a></li>
  		  <li><a href="<?=site_url()?>PgMswAided/stu_zoom_list"><i class="fa fa-circle-o"></i> Shortlisted Candidates</a></li>
  		  <li><a href="<?=site_url()?>PgMswAided/createPanel"><i class="fa fa-circle-o"></i> Create Panel</a></li>
  		  <li><a href="<?=site_url()?>PgMswAided/allotPanel"><i class="fa fa-circle-o"></i> Panel Allocation</a></li>
  		  <li><a href="<?=site_url()?>PgMswAided/stuWOZoom"><i class="fa fa-circle-o"></i> Shortlisted Candidates</a></li>
      ...
      <li>
        ...
        <ul class="sidebar-submenu">
  		  <li><a href="<?=site_url()?>PgMswAided/interviewAttendedStudent"><i class="fa fa-circle-o"></i> Dept. Verification</a></li>
        <li><a href="<?=site_url()?>PgMswAided/SeatAllocation"><i class="fa fa-circle-o"></i> Seat Allocation</a></li>
  		  <li><a href="<?=site_url()?>PgMswAided/tempShortlist"><i class="fa fa-circle-o"></i> Shortlist Candidates</a></li>
  		  <li><a href="<?=site_url()?>PgMswAided/SelectionStatus"><i class="fa fa-circle-o"></i> Take PDF </a></li>
  		  <li><a href="<?=site_url()?>PgMswAided/principalApproved"><i class="fa fa-circle-o"></i> Publish & Admit</a></li>
  		  <li><a href="<?=site_url()?>PgMswAided/admittedStudent"><i class="fa fa-circle-o"></i> Assign Register Number</a></li>
        ...
        <ul class="sidebar-submenu">
  		  <li><a href="<?=site_url()?>CommonFunction/excelImport/2/<?=$this->session->userdata('user')['user_dep_status']?>"><i class="fa fa-circle-o"></i> Export Application</a></li>
				<li><a href="<?=site_url()?>PgMswAided/studentannouncements/"><i class="fa fa-circle-o"></i> Student Announcements</a></li>
