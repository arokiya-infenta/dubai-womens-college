...
?>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Assign  Course 
            ...
            <a class="btn btn-primary"  data-toggle="modal" data-target="#myModal" style="float:right;margin-right: 10px;" href="">Status Update</a>
...
<tr>
 ...
 <td><?=$applied[0]->pr_certificate_regist_numb?></td>
            ...
            <div style="overflow-x:auto;">
                    ...
                    <tr>
                   <th>Subjects</th>
                   <th colspan="4" style="text-align: center;">Plus One</th>
                   <th colspan="3" style="text-align: center;">Plus Two</th>
  ...
  <div class="modal-dialog">
    ...
    <form method="post" action="<?=base_url()?>Admin/updateInterviewApplied">
      ...
      <div class="modal-body">
       ...
       <input type="hidden" id="user_id" name="user_id" value="<?=$applied[0]->pr_user_id?>" >
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <form method="post" action="<?=base_url()?>Admin/updateAdmit">

      <div class="modal-body">
       <label class ="text-aa">Status </label>
      

       <select  required id="adm-status" name="status_one" class="form-control">
...
<textarea name="comments"  class="form-control">
     ...
     <label  class ="text-aa">Reschedule Course   </label>
...
<?php foreach($course as $val){
    ...
    ?>
<option <?php if($schdate[0]->sa_course_comformed == $val->cs_id){ echo"selected";} ?> value="<?=$val->cs_id?>"><?=$val->cs_name?></option>
