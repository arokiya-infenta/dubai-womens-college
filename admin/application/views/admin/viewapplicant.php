...
?>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Users Registered <a class="btn btn-primary"  data-toggle="modal" data-target="#myModal" style="float:right" href="">Schedule Date</a>
 ...
 <div class=""> 
          ...
          <img src="<?=$string?>/uploads/<?=$applied[0]->pr_photo?>" height="200px;" width="150px;" alt="Card image cap"/>
                 ...
                 <tr>
                                 ...
                                 <th>Mobile number</th>
                                 <td><?=$user[0]->u_mobile?></td>
                             </tr>  <tr>
                                 <th>Email id</th>
                                 <td><?=$user[0]->u_email_id?></td>
                             </tr>    
         ...
         <td><?=$applied[0]->pr_father_anuval_income?></td>
            ...
            <h4><i class="fa fa-user" aria-hidden="true"></i> Educational Details</h4>
...
<tr>
 ...
 <td><?=$applied[0]->pr_certificate_regist_numb?></td>
  ...
  <div class="modal-dialog">
    ...
    <form method="post" action="<?=base_url()?>Admin/updateInterview">

      <div class="modal-body">
       <label>Interview Date </label>
       <input type="date" name="int_date" required class="form-control">
       <label>Interview Time </label>
       <input type="time" name="int_time" class="form-control">
       <input type="hidden" name="user_id" required value="<?=$applied[0]->pr_user_id?>" >
