...
<?php if($user[0]->pr_photo == "" || $user[0]->pr_photo == NULL ){echo"<h3>Image not uploaded";}else{?>
					<img src="<?=base_url()?>uploads/<?=$user[0]->pr_photo?>">
<?php } ?>      
				</div>
				<div class="user-data">
         ...
         <!-- <a style="float:right;" target="_blank" href="<?=base_url()?>Home/downloadPdF" >Download PDF</a>-->
			...
			<div class="tab-panel-main">
				<ul class="tabs">
					<li class="tab-link current"   style="width: 200px;"  data-tab="Basic-detail">Basic Details</li>
					<li class="tab-link"  style="width: 200px;"  data-tab="Edu-detail">Educational Details</li>
					<li class="tab-link"   style="width: 200px;"  data-tab="Portfolio">Mark Details</li>
<?php
