...
<div class="row form-group">
  ...
  <div class="col-md-9">
    <input type="text"  value="<?=$user[0]->pr_applicant_name?>"  id="candidate_name" name="candidate_name"  class="form-control">
  </div>
</div>
...
<div class="row form-group">
  ...
  <div class="col-md-9">
    <input type="email"  value="<?=$user[0]->candidate_email?>"  id="email" name="candidate_email"  class="form-control">
  </div>
</div>
...
<div class="row form-group">
  ...
  <div class="col-md-9">
    <input type="number"  value="<?=$user[0]->candidate_mobile?>"  name="candidate_mobile" class="form-control">
  </div>
</div>
<div class="row form-group">
...
<div class="row form-group">
  ...
  <div class="col-md-4">
    <input type="text"    class="form-control" name="m_tounge" value="<?=$user[0]->pr_mother_toung?>"  >
  </div>
...
<div class="row form-group">
  ...
  <label class="radio-inline">
    ...
    <label class="radio-inline">
      <input type="radio" name="gender"   <?php if($user[0]->pr_gender=="Others"){echo"checked";} ?> value="Others"> Transgender
    </label>
...
<div id="nationality"> 
  ...
  <label class="radio-inline">
      <input type="radio" name="Nationality"  <?php if($user[0]->pr_nationality=="Indian"){echo"checked";} ?> value="Indian"> Indian
    </label>
    <label class="radio-inline">
      <input type="radio" name="Nationality"  <?php if($user[0]->pr_nationality=="Foreign "){echo"checked";} ?> value="Foreign "> Foreign 
    </label>

</div>

    <!--<input type="text" id="Nationality" require name="Nationality"  value="<?=$user[0]->pr_nationality?>"  class="form-control">-->
  </div>
</div>
...
<div class="row form-group">
  ...
  <label class="radio-inline">
    ...
    <label class="radio-inline">
      <input type="radio" name="Community"  <?php if($user[0]->pr_community=="MBC / DNC"){echo"checked";} ?> value="MBC / DNC" > MBC / DNC
    </label>
  ...
  <div class="col-md-12">
  <span class=""> [Note: If your community certificate is not issued within Tamil Nadu, select OC.]</span>
  </div>
</div>
</div>
<div class="col-md-4">
<label class="">
    ...
    <?php 
?>
<input type="file" id="profile-img" <?php  if($user[0]->pr_photo == "" || $user[0]->pr_photo == null  ){echo "";} ?>  name="profile-img" value="<?=$user[0]->pr_photo?>" class="form-control">
<br>
...
<br>
<br>
<span class="">Your Passport size photo must have White background and of the size of 2 inch x 2 inch or 51 mm x 51 mm</span>
...
<div class="col-md-8">
<textarea class="form-control"  name="local_address" rows="5" id="localddress"><?=$user[0]->pr_local_address?></textarea>
</div>
</div><br>
...
<div class="col-md-8">
<input type="text" id="local_city" name="local_city"  value="<?=$user[0]->pr_local_city?>" class="form-control">
</div>
</div>
<br>
<div class="row">
...
<div class="col-md-8">
<input type="text"  id="local_state"   name="local_state"  value="<?=$user[0]->pr_local_state?>"  class="form-control">
</div>
</div>
<br>
<div class="row">
...
<div class="col-md-8">
<input type="text"  id="local_country" name="local_country" value="<?=$user[0]->pr_local_country?>"  class="form-control">
</div>
</div>
<br>
<div class="row form-group">
...
<div class="col-md-8">
<input type="text"  id="local_pincode" name="local_pincode" value="<?=$user[0]->pr_local_pincode?>"  class="form-control">
</div>
</div>
</div>
<div class="col-md-6">
...
<span class="">Upload your certificates in JPEG or PDF format File size within 1 MB or 1024 KB </label>
</div>
...
<div class="col-md-8">
<input type="text"  id="local_state"   name="sslc_institution"  value="<?=$user[0]->pr_sslc_school?>"  class="form-control">
</div>
</div>
<br>
<div class="row">
...
<div class="col-md-8">
<input type="text"  id="local_country" name="sslc_medium" value="<?=$user[0]->pr_sslc_medium_of_inst?>"  class="form-control">
</div>
</div>
<br>
...
<div class="col-md-8">
<input type="month"    name="year_of_passing_sslc"  value="<?=$user[0]->pr_sslc_year_of_passing?>"    class="form-control">
</div>
</div>
<br>
<div class="row form-group">
...
<label class="col-md-4 control-label" for="selectbasic">Name of the School </label>
<div class="col-md-8">
<input type="text"    name="plus2_institution"  value="<?=$user[0]->pr_plus2_school?>"  class="form-control">
</div>
</div>
<br>
<div class="row">
<label class="col-md-4 control-label" for="selectbasic">Medium of Instruction </label>
<div class="col-md-8">
<input type="text"  id="local_country" name="plus2_medium" value="<?=$user[0]->pr_plus2_medium_of_inst?>"  class="form-control">
</div>
</div>
<div class="row">
...
<!--<label class="radio-inline">
    ...
    <label class="radio-inline">
      <input type="radio"  name="study_bord"  <?php if($user[0]->pr_board_study=="TNHSC"){echo"checked";} ?>  value="TNHSC"  > TN HSC
    </label>  
    <label class="radio-inline">
...
<label class="col-md-4 control-label" for="selectbasic">Year of Passing </label>
<div class="col-md-8">
<input type="month"    name="year_of_passing_plus2"  value="<?=$user[0]->pr_plus2_year_of_passing?>"    class="form-control">
</div>
</div>
<br>
<div class="row form-group">
