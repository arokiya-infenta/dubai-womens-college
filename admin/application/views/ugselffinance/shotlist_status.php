                                ...
                                <table class="table" cellspacing="0">
                                    ...
                                    <?php foreach($selection_list as $sl){  ?> 
                                        <tr>
                                            ...
                                            <td><a  class="text-primary" href="<?=base_url()?>UgSelfFinance/ShotlistedCandidates/1/<?=$sl->selection_list_name?>">view</a> | <a  class="text-danger" href="<?=base_url()?>UgSelfFinance/deleteShotlistedCandidates/1/<?=$sl->selection_list_name?>">Delete</a></td>
                                        </tr>
                                        <?php } ?>
                                ...
                                <table class="table" cellspacing="0">
                                    ...
                                    <?php foreach($Waitinglist_list as $sl){  ?> 
                                        <tr>
                                            <td><?=$sl->selection_list_name?></a></td>
                                            <td><?=date("d-m-Y",strtotime($sl->created))?></td>
                                            <td><a  class="text-primary" href="<?=base_url()?>UgSelfFinance/ShotlistedCandidates/2/<?=$sl->selection_list_name?>">view</a> | <a  class="text-danger" href="<?=base_url()?>UgSelfFinance/deleteShotlistedCandidates/2/<?=$sl->selection_list_name?>">Delete</a>
                                        </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                ...
                                <table class="table" cellspacing="0">
                                    ...
                                    <?php foreach($rejection_list as $sl){  ?> 
                                        <tr>
                                            <td><?=$sl->selection_list_name?></a></td>
                                            <td><?=date("d-m-Y",strtotime($sl->created))?></td>
                                            <td><a class="text-primary" href="<?=base_url()?>UgSelfFinance/ShotlistedCandidates/3/<?=$sl->selection_list_name?>">view</a> | <a  class="text-danger" href="<?=base_url()?>UgSelfFinance/deleteShotlistedCandidates/3/<?=$sl->selection_list_name?>">Delete</a>
                                        </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
