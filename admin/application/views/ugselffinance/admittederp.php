...
<div class="col-lg-2"> <a href="<?=base_url()?>CommonFunction/admitStudentErp/5/<?=$this->session->userdata("user")["user_dep_status"]?>" class="btn btn-secondary"> Admit ERP</a></div>            
         

<div class="col-lg-4">
<a href="<?=base_url()?>CommonFunction/admitStudentErp/5/<?=$this->session->userdata("user")["user_dep_status"]?>" class="btn btn-secondary"> Delete Admitted ERP</a>
</div>
