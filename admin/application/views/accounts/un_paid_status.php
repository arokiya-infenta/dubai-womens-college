...
echo $this->session->flashdata('message');
	 ...
	 <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-file-text"></i> Un Paid student
					
					  <!--<a  style="float: right;" class="btn btn-primary" href="<?=base_url()?>Accounts/unPaidUserReport/<?=$main_id?>/<?=$course_id?>/<?=$year?>/<?=$batch?>/<?=$category?>/" >Export Excel</a>
   ...
   <!-- <form id="myForm" action="<?=base_url().'accounts/selectClassReport'?>" method="post">	-->
    	<form id="myForm" action="<?=base_url().'accounts/unPaidGenReport'?>" method="post">	
	    <div class="row">
			<div class="col-md-3">
			<label>Stream</label>
