        ...
        <div class="col-lg-12">
          <div class="card">
			...
			<div class="hide-it" align="center"><h4 style="color:#15ca20;"><?php echo $this->session->flashdata('success'); ?></h4></div>
			   <h4>Shortlisted Candidate <?php if(!empty($stu_list)){echo '- ' .$stu_list[0]->title;} ?> 
            ...
            <?php   }?><a class="text-right btn btn-primary" href = "<?=base_url()?>PgSelfFinance/panelPdf/<?=$this->uri->segment(3);?>"><i class="fa fa-file-text" aria-hidden="true"></i> Download Panel Report</a></span>
			</div>
            <div class="card-body"> 
...
$(document).ready(function() {
	...
	swal({
	  ...
	  function(isConfirm) {
		...
		$.ajax({
			url: "<?php echo base_url();?>pgSelfFinance/delete_stu_zoom",
			method: "POST",
			cache: false,
			data:{
				type: 2,
...
if (r == true) {
    ...
    //alert("yes");
   $.ajax({
			url: "<?php echo base_url();?>pgSelfFinance/publishPanel",
			method: "POST",
			cache: false,
			data:{
				panel_id: panel_id,
