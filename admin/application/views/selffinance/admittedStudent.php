        ...
        <div class="col-lg-12">
         ...
         <div class="modal fade" id="defaultsizemodal">
                  <div class="modal-dialog">
                    ...
                    <form method="post" action="<?=base_url()?>PgSelfFinance/registerNumberFormat">
...
<div class="col-lg-2"> <a href="<?=base_url()?>PgSelfFinance/assignRegisterNumber/<?=$dep?>/<?=date('y')?>" class="btn btn-secondary"> Assign Register number</a></div>            
