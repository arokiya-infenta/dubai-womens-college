      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="col-lg-4">    
            <form id="target" action="<?=base_url()?>PgSelfFinance/publishResult">
...
$i=1;
                    ...
                    foreach ($student as $key => $value) { 
                      ...
                      <div class="modal fade  bd-example-modal-xl" id="largesizemodal-<?=$value->sl_id?>">
...
if($t == 1){
  ...
  $st = "";
                      ...
                      <form method="POST" action="<?=base_url()?>PgSelfFinance/admitStudent">
...
<text type="text"  class="form-control" value="<?=$value->pr_permanent_address?>" name="app_address"><?=$value->pr_permanent_address?></text>
                      ...
                      <img src="<?=base_url()?>/uploads/<?=$value->pr_photo?>" width="600px" height="600px" ></div>
                      </div>
