    ...
    <div class="container-fluid">
	  ...
	  <div class="row">
	    ...
	    <div class="hide-it" align="center"><h4 style="color:#15ca20;"><?php echo $this->session->flashdata('form_err'); ?></h4></div>
            <div class="card-header"> Generate Zoom Link</div>
            <div class="card-body">
			  ...
			  <table id="default-datatable" class="table table-bordered">
				...
				?>
                    <tr>
                        ...
                        <td>
						<!--<a href="<?php echo base_url('zoom/zoom_view/').$links->id; ?>">
						<i class="btn-secondary fa fa-eye" style="width:21px;height:17px;padding-left:3px;"></i></a>-->
