        ...
        <div class="col-lg-12">
         ...
         <div class="modal fade" id="defaultsizemodal">
                  <div class="modal-dialog">
                    ...
                    <form method="post" action="<?=base_url()?>PgMswSelfFin/registerNumberFormat">
...
<div class="col-lg-2"> <a href="<?=base_url()?>PgMswSelfFin/assignRegisterNumber/<?=$dep?>/21" class="btn btn-secondary"> Assign Regfister number</a></div> 
