  ...
  <div class="content-wrapper">
	...
	<div class="profile-main">
        ...
        <h4><?=$user[0]->pr_applicant_name?></h4>
             ...
             <form method = "post" action="<?=base_url()?>PgMswSelfFin/certificateComments">
...
echo"<tr><th>Semester - I Mark Sheet</th><td>Not Uploaded</td><td><textarea name='pr_semester_1' class='form-control' >".$user_certificate[0]->pr_semester_1."</textarea></td></tr>";
     ...
     echo"<tr><th>Semester - I Mark Sheet</th><td><a target='_blank' href='".base_url()."PgMswSelfFin/UploadFile?file=".urlencode($user[0]->pr_semester_1)."'>Download</a></td><td><textarea name='pr_semester_1' class='form-control' >".$user_certificate[0]->pr_semester_1."</textarea></td></tr>";
                         }  ?>
...
echo"<tr><th>Semester - II Mark Sheet</th><td>Not Uploaded</td><td><textarea name='pr_semester_2' class='form-control' >".$user_certificate[0]->pr_semester_2."</textarea></td></tr>";
     ...
     echo"<tr><th>Semester - II Mark Sheet</th><td><a target='_blank' href='".base_url()."PgMswSelfFin/UploadFile?file=".urlencode($user[0]->pr_semester_2)."'>Download</a></td><td><textarea name='pr_semester_2' class='form-control' >".$user_certificate[0]->pr_semester_2."</textarea></td></tr>";
                         }  ?>
...
echo"<tr><th>Semester - III Mark Sheet</th><td>Not Uploaded</td><td><textarea name='pr_semester_3' class='form-control' >".$user_certificate[0]->pr_semester_3."</textarea></td></tr>";
     ...
     echo"<tr><th>Semester - III Mark Sheet</th><td><a target='_blank' href='".base_url()."PgMswSelfFin/UploadFile?file=".urlencode($user[0]->pr_semester_3)."'>Download</a></td><td><textarea name='pr_semester_3' class='form-control' >".$user_certificate[0]->pr_semester_3."</textarea></td></tr>";
                         }  ?>
...
echo"<tr><th>Semester - IV Mark Sheet</th><td>Not Uploaded</td><td><textarea name='pr_semester_4' class='form-control' >".$user_certificate[0]->pr_semester_4."</textarea></td></tr>";
     ...
     echo"<tr><th>Semester - IV Mark Sheet</th><td><a target='_blank' href='".base_url()."PgMswSelfFin/UploadFile?file=".urlencode($user[0]->pr_semester_4)."'>Download</a></td><td><textarea name='pr_semester_4' class='form-control' >".$user_certificate[0]->pr_semester_4."</textarea></td></tr>";
                         }  ?>
...
echo"<tr><th>Semester - V Mark Sheet</th><td>Not Uploaded</td><td><textarea name='pr_semester_5' class='form-control' >".$user_certificate[0]->pr_semester_5."</textarea></td></tr>";
     ...
     echo"<tr><th>Semester - V Mark Sheet</th><td><a target='_blank' href='".base_url()."PgMswSelfFin/UploadFile?file=".urlencode($user[0]->pr_semester_5)."'>Download</a></td><td><textarea name='pr_semester_5' class='form-control' >".$user_certificate[0]->pr_semester_5."</textarea></td></tr>";
                         }  ?>
...
echo"<tr><th>Semester - VI Mark Sheet</th><td>Not Uploaded</td><td><textarea name='pr_semester_6' class='form-control' >".$user_certificate[0]->pr_semester_6."</textarea></td></tr>";
     ...
     echo"<tr><th>Semester - VI Mark Sheet</th><td><a target='_blank' href='".base_url()."PgMswSelfFin/UploadFile?file=".urlencode($user[0]->pr_semester_6)."'>Download</a></td><td><textarea name='pr_semester_6' class='form-control' >".$user_certificate[0]->pr_semester_6."</textarea></td></tr>";
                         }  ?>
...
echo"<tr><th>Semester - VIIMark Sheet</th><td>Not Uploaded</td><td><textarea name='pr_semester_7' class='form-control' >".$user_certificate[0]->pr_semester_7."</textarea></td></tr>";
     ...
     echo"<tr><th>Semester - VII Mark Sheet</th><td><a target='_blank' href='".base_url()."PgMswSelfFin/UploadFile?file=".urlencode($user[0]->pr_semester_7)."'>Download</a></td><td><textarea name='pr_semester_7' class='form-control' >".$user_certificate[0]->pr_semester_7."</textarea></td></tr>";
                         }  ?>
...
echo"<tr><th>Semester - VIII Mark Sheet</th><td>Not Uploaded</td><td><textarea name='pr_semester_8' class='form-control' >".$user_certificate[0]->pr_semester_8."</textarea></td></tr>";
     ...
     echo"<tr><th>Semester - VIII Mark Sheet</th><td><a target='_blank' href='".base_url()."PgMswSelfFin/UploadFile?file=".urlencode($user[0]->pr_semester_8)."'>Download</a></td><td><textarea name='pr_semester_8' class='form-control' >".$user_certificate[0]->pr_semester_8."</textarea></td></tr>";
                         }  ?>
...
echo"<tr><th>Provisional UG Degree Certificate</th><td>Not Uploaded</td><td><textarea name='pr_provisional_pg_cer' class='form-control' >".$user_certificate[0]->pr_provisional_pg_cer."</textarea></td></tr>";
     ...
     echo"<tr><th>Provisional UG Degree Certificate</th><td><a target='_blank' href='".base_url()."PgMswSelfFin/UploadFile?file=".urlencode($user[0]->pr_provisional_pg_cer)."'>Download</a></td><td><textarea name='pr_provisional_pg_cer' class='form-control' >".$user_certificate[0]->pr_provisional_pg_cer."</textarea></td></tr>";
                         }  ?>
...
echo"<tr><th>UG Degree Certificate</th><td>Not Uploaded</td><td><textarea name='pr_ug_cer' class='form-control' >".$user_certificate[0]->pr_ug_cer."</textarea></td></tr>";
     ...
     echo"<tr><th>UG Degree Certificate</th><td><a target='_blank' href='".base_url()."PgMswSelfFin/UploadFile?file=".urlencode($user[0]->pr_ug_cer)."'>Download</a></td><td><textarea name='pr_ug_cer' class='form-control' >".$user_certificate[0]->pr_ug_cer."</textarea></td></tr>";
                         }  ?>
...
echo"<tr><th>Cumulative Mark Sheet</th><td>Not Uploaded</td><td><textarea name='pr_cummulative_cer' class='form-control' >".$user_certificate[0]->pr_cummulative_cer."</textarea></td></tr>";
     ...
     echo"<tr><th>Cumulative Mark Sheet</th><td><a target='_blank' href='".base_url()."PgMswSelfFin/UploadFile?file=".urlencode($user[0]->pr_cummulative_cer)."'>Download</a></td><td><textarea name='pr_cummulative_cer' class='form-control' >".$user_certificate[0]->pr_cummulative_cer."</textarea></td></tr>";
                         }  ?>
...
echo"<tr><th>Community Certificate</th><td>Not Uploaded</td><td><textarea name='pr_community_cer' class='form-control' >".$user_certificate[0]->pr_community_cer."</textarea></td></tr>";
     ...
     echo"<tr><th>Community Certificate</th><td><a target='_blank' href='".base_url()."PgMswSelfFin/UploadFile?file=".urlencode($user[0]->pr_community_cer)."'>Download</a></td><td><textarea name='pr_community_cer' class='form-control' >".$user_certificate[0]->pr_community_cer."</textarea></td></tr>";
                         }  ?>
...
echo"<tr><th>Conduct Certificate</th><td>Not Uploaded</td><td><textarea name='pr_conduct_cer' class='form-control' >".$user_certificate[0]->pr_conduct_cer."</textarea></td></tr>";
     ...
     echo"<tr><th>Conduct Certificate</th><td><a target='_blank' href='".base_url()."PgMswSelfFin/UploadFile?file=".urlencode($user[0]->pr_conduct_cer)."'>Download</a></td><td><textarea name='pr_conduct_cer' class='form-control' >".$user_certificate[0]->pr_conduct_cer."</textarea></td></tr>";
                         }  ?>
...
echo"<tr><th>Transfer Certificate</th><td>Not Uploaded</td><td><textarea name='pr_transfer_cer' class='form-control' >".$user_certificate[0]->pr_transfer_cer."</textarea></td></tr>";
     ...
     echo"<tr><th>Transfer Certificate </th><td><a target='_blank' href='".base_url()."PgMswSelfFin/UploadFile?file=".urlencode($user[0]->pr_transfer_cer)."'>Download</a></td><td><textarea name='pr_transfer_cer' class='form-control' >".$user_certificate[0]->pr_transfer_cer."</textarea></td></tr>";
                         }  ?>
