...
echo $this->session->flashdata('message');
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            ->where("sl_main_id",3)->where("sl_course_id",$this->session->userdata("user")["user_dep_status"])->where("selection_list_name",$reservation_type)
            ->where("published",1)
            ...
            <?php  }else{ ?>
              ...
              <form method="post" action ="<?=base_url()?>PgMswSelfFin/publishSelectionCandidateList">
...
<input type="hidden" name="reservation" value="<?=$reservation_type?>" >
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form method="POST" action="<?=base_url()?>PgMswSelfFin/ShotlistPdf">
