...
<div class="col-lg-2"> <a href="<?=base_url()?>CommonFunction/admitStudentErp/3/<?=$this->session->userdata("user")["user_dep_status"]?>" class="btn btn-secondary"> Admit ERP</a></div>            
