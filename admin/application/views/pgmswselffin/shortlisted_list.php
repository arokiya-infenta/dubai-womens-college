...
var saveData = $.ajax({
		type: 'POST',
		url: "<?=base_url()?>PgMswSelfFin/ManualSelectWaitingList",
		data: {id:m,sel:csl},
		dataType: "text",
...
if (r == true) {
  ...
  var saveData = $.ajax({
      type: 'POST',
      url: "<?=base_url()?>PgMswSelfFin/convertWaitingList",
      data: {sel:csl},
      dataType: "text",
      success: function(resultData) { 
//alert(resultData);
...
return false;
  ...
  $("#allsele_pdf").attr("href", "<?= base_url() ?>PgMswSelfFin/SelectionlistPdf/<?=$this->uri->segment(3); ?>/"+csl);
 // return true;
 $("#allsele_pdf").click();
}
//e.preventDefault();
...
var saveData = $.ajax({
    type: 'POST',
    url: "<?=base_url()?>PgMswSelfFin/SelectWaitingList",
    data: {id:m,sel:csl},
    dataType: "text",
    success: function(resultData) { 
//alert(resultData);
...
if (r == true) {
  ...
  var saveData = $.ajax({
      type: 'POST',
      url: "<?=base_url()?>PgMswSelfFin/rejectSelectionList",
      data: {id:m},
      dataType: "text",
      success: function(resultData) { 
//alert(resultData);
