      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            ...
            <?php   }?><a class="text-right btn btn-primary" href = "<?=base_url()?>pgMswSelfFin/panelPdf/<?=$this->uri->segment(3);?>"><i class="fa fa-file-text" aria-hidden="true"></i> Download Panel Report</a></span>
			</div>
            <div class="card-body">
...
$(document).ready(function() {
	...
	swal({
	  ...
	  function(isConfirm) {
		...
		$.ajax({
			url: "<?php echo base_url();?>pgMswSelfFin/delete_stu_zoom",
			method: "POST",
			cache: false,
			data:{
				type: 2,
			...
			success: function(dataResult){
				...
				//window.location.href="<?php echo base_url();?>pgMswSelfFin/stu_zoom_list_det";
			}
		});
		}else{
...
if (r == true) {
    $.ajax({
			url: "<?php echo base_url();?>PgMswSelfFin/publishPanel",
			method: "POST",
			cache: false,
			data:{
				panel_id: panel_id,
