      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            ...
            <?php   }?><a class="text-right btn btn-primary" href = "<?=base_url()?>PgDiploma/panelPdf/<?=$this->uri->segment(3);?>"><i class="fa fa-file-text" aria-hidden="true"></i> Download Panel Report</a></span>
			</div>
            <div class="card-body"> 
...
$(document).ready(function() {
	...
	swal({
	  ...
	  function(isConfirm) {
		...
		$.ajax({
			url: "<?php echo base_url();?>diploma/delete_stu_zoom",
			method: "POST",
			cache: false,
			data:{
				type: 2,
...
if (r == true) {
    ...
    //alert("yes");
   $.ajax({
			url: "<?php echo base_url();?>pgDiploma/publishPanel",
			method: "POST",
			cache: false,
			data:{
				panel_id: panel_id,
