    ...
    <div class="container-fluid">
	  ...
	  <div class="row">
        <div class="col-lg-12">
	      ...
	      <div class="hide-it" align = "center" ><h4 style="color:#15ca20;"><?php echo $this->session->flashdata('form_err'); ?></h4></div>
			...
			<form action="<?php echo base_url().'pgMswAided/stuCmnty'; ?>" method="post">
			  <div class="row">
			  <div class="col-lg-3">
	 ...
	 <?php if(isset($stu_list)){?>
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
		  <form action="<?php echo base_url().'pgMswAided/zoom_alloc'; ?>" method="post">
            ...
            <div class="card-body">
              ...
              <table id="examplezoomview" class="table table-bordered">
				...
				<?php foreach($stu_list as $slist) { ?>
					...
					$app_no= $this->db->select("*")->from("Applyed_Cources")->Where("user_id",$slist->pr_user_id)->Where("applied_course_id",$dpmnt)->where('main_course_id','2')->get()->row();
