        ...
        <div class="col-lg-12">
         ...
         <div class="modal fade" id="defaultsizemodal">
                  <div class="modal-dialog">
                    ...
                    <form method="post" action="<?=base_url()?>PgMswAided/registerNumberFormat">
...
$nt =  $this->db->select("*")->from("student_reg_number_format")->where("dep",$dep)->get()->result();
...
foreach ($nt as $key => $value) {
  ...
  <td>'.$value->reg_no_start.' / '.$value->reg_no_end.'</td>
...
<div class="col-lg-2"> <a href="<?=base_url()?>PgMswAided/assignRegisterNumber/<?=$dep?>/21" class="btn btn-secondary"> Assign Regfister number</a></div>   
