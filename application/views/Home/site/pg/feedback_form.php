...
<div class="section contact_section" style="background:#12385b;">
					 ...
					 <div class="col-md-2 "></div>
		                    ...
		                    <div class="headings">
			                    ...
			                    <div class="row foot-dist">
									...
									<h2 class="ttl text-center">Pending FeedBack form </h2>

						   <?php 
						   if(sizeof($subject)==0){

							echo"<h2 class='ttl text-center' style='color:green;'>No Pending Feedback</h2>";

						   }
						 
						 foreach ($subject as $key => $svalue) { ?>
	...
	<?php } ?>
			                    	...
			                    	<div class="col-lg-5 jump-side">
									<h2 class="ttl text-center">Submitted FeedBack  </h2>
									<?php foreach ($s_subject as $key => $svalue) { ?>
							<a style="color: white;" href="#">* <?= $svalue->subName?></a><br>
