...
$m = $this->db->select("*")->from("stu_user")->where("u_id",$this->session->userdata('user')['user_id'])->where("u_year",date("Y"))->get();
...
?>
				        		...
				        		<h5 class="all-head"><b><a href="<?=base_url()?>Admissions" >Admission</a></b></h5>
...
if($u_reg_num == ""){ ?>
			                    	...
			                    	<div class="col-lg-3 jump-side">
			                    		<div class="box-shadow">
											...
											<a style="color:white" href="/landing/PG_Admission.pdf" download><p class="wps">PG Admission schedule 2023  </p> </a>
