...
<div class="section contact_section" style="background:#12385b;">
					 ...
					 <div class="col-md-2 "></div>
		                    ...
		                    <div class="headings">
			                    ...
			                    <div class="row foot-dist">
									...
									<h2 class="ttl text-center">Time Table </h2>
    ...
    <tr>
      ...
      <th scope="col">AN / FN</th>
    </tr>
  </thead>
  <tbody>
						   <?php $i=1;   foreach ($timetable as $key => $svalue) { 
      ...
      <td><?=$sem?></td>
      <td><?=date("d-M-Y",strtotime($svalue->schedule_date))?></td>
      <td><?=$svalue->section?></td>
