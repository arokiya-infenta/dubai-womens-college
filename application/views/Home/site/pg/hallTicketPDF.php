      ...
      <div class="row">
        <div class="col-lg-12">
		  ...
		  <table cellpadding=0 cellspacing=0>
			<td><img src="https://admission.mssw.in/admin/uploads/logo.png" style="width:100px;height:100px;"></td>
...
?>
			...
			$prec = round(($present/$total)*100,0);
			}else{$prec = 0;}
			...
			?>
			<tr class="table1">
			<td class="table1"><?=$subject->subCode?></td>
			...
			<td><p>      
			<span><img src="https://admission.mssw.in/admin/uploads/coe-sign.jpg" style="width:170px;height:50px;margin-top:-25px;"></span></p>
			<p>     
