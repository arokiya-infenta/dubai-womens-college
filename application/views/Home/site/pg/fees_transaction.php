...
<input type="hidden" name="iv" value="2319966707XGLFIW"/>
     ...
     <input type="hidden" name="returnURL" value='<?=base_url();?>MyExamination/myexamFees/'/>
     <br>
...
<div class="container">
  ...
  <button class="btn btn-secondary onclick="history.go(-1);">Back </button>
     <input type="submit" class="btn btn-success" name="submit" value="Accept and Proceed to pay ₹ 2" />
</div>
</div>
</form>
