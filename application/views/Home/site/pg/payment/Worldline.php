...
t Type</label>o</td>
     ...
     <tr>
         ...
         <td><input type="text" name="mrctCode" value="L74264"/></td>
     </tr>
     <tr>
     ...
     <tr>
         ...
         <td><input type="text" name="city" value="Mumbai"/></td>
     </tr>
     <tr>
         <td><label>Request Detail</label></td>
         <td><input type="text" name="reqDetail" value="MSSW_2.0_0.0"/></td>
     </tr>
     <tr>
...
<tr>
 ...
 <td><input type="text" name="key" value="1954988003KTWAQS"/></td>
</tr>
<tr>
 <td><label>IV</label></td>
 <td><input type="text" name="iv" value="2319966707XGLFIW"/></td>
</tr>
<tr>
 <td><label>Return URL </label></td>
 <td>
     <input type="text" name="returnURL" value='<?=base_url()?>PayFees/testPayment'/>
 </td>
</tr>
<tr>
    <td colspan=2>
