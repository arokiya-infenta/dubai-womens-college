...
<div id="online_exm">
    <div class="container">
        <div class="row">
                ...
                <legend class="head-one"> <h2 class="ttl">Entrance Test Marks </h2></legend> 
...
<div class="rond col-md-2">

<h5 style="color: white;">
<b>
<?php if($rest->exam_category == "MSW"){
echo"M.S.W.(Aided), M.S.W.(SF), M.S.W.(D&E)";

}else if($rest->exam_category == "MAHRM"){

    echo"M.A.HRM & M.A.HR & OD";

}else if($rest->exam_category == "MASE"){

    echo"M.A.SE";

}else if($rest->exam_category == "MADM"){

    echo"M.A.DM";

}else if($rest->exam_category == "MSCCF"){

    echo"M.Sc Psychology";
...
<h5 style="color: white;">
Total No.of Questions Answered = <?=$rest->question_attended?>
</h5>
</div>
<div class="rond col-md-2">
<h5 style="color: white;">
Total No.of Correct Answers = <?=$rest->total_mark?>
</h5>
</div>
<div class="rond col-md-3">
<h5 style="color: white;">
Your Entrance Test Marks = <?=$rest->total_mark?>
</h5>
</div>
