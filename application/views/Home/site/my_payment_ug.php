...
redirect('Home/ResponsePaymentUg/'.$insert_id);
...
//print_r($_SESSION);
  ...
  redirect('Home/ResponsePaymentUg/0');
...
<div class="row">
    ...
    <!--<select name="reqType">
        ...
        <input type="hidden" name="itc" value="~<?=$user[0]->pr_user_id?>~<?=$user[0]->pr_course_1?>~"/>
...
<input type="hidden" name="iv" value="2319966707XGLFIW"/>
     ...
     <input type="hidden" name="returnURL" value='<?=base_url();?>Home/PaymentUg'/>
     <br>
