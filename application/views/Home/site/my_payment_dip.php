...
redirect('Home/ResponsePaymentDip/'.$insert_id);
...
//print_r($_SESSION);
  ...
  redirect('Home/ResponsePaymentDip/0');
...
$arrt = explode(",",$user[0]->pr_course_1);
 ...
 if($user[0]->pr_course_1 == null || $user[0]->pr_course_1 ==""){
    ...
    $main_1 = $num_pri * 500 ;
        ...
        $htyml ="<h1>Dip</h1><h2>Application Fees Details</h2><table>
        <tr>
          <th>S.No</th>
          <th>Details</th>
          <th>Fees</th>
...
<input type="hidden" name="iv" value="2319966707XGLFIW"/>
     ...
     <input type="hidden" name="returnURL" value='<?=base_url();?>Home/PaymentDip'/>
     <br>
