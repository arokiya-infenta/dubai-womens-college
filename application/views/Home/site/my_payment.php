...
$arrays = array(
  "af_main_id"=>$arr_usd[2],
  "af_course_id"=>$arr_usd[2],
  "af_student_id"=>$arr_usd[2],
  "af_fees_id"=>$arr_usd[2],
  "af_fees_name"=>$arr_usd[2],
  "af_fees_total_amt"=>$arr_usd[2],
  "af_paid_status"=>$arr_usd[2],
  "af_response"=>$arr_usd[2],
  "af_response_time"=>$arr_usd[2],
...
<div class="row">
    ...
    <!--<select name="reqType">
        ...
        <input type="hidden" name="reqDetail" value="MSSW_<?php echo $total; ?>.0_0.0"/>
...
<input type="hidden" name="iv" value="2319966707XGLFIW"/>
     ...
     <input type="hidden" name="returnURL" value='<?=base_url();?>Home/PaymentPg'/>
     <br>
...
<div class="container">
  <div class="vertical-center">
     ...
     <input type="submit" class="button" name="submit" value="Pay Fees <?php echo $total; ?> ₹" />
</div>
</div>
</form>
