...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <header class="top-header">
        ...
        <nav class="navbar header-nav navbar-expand-lg">
            <div class="container">
                <a class="navbar-brand" href="#"><img src="<?=base_url()?>/landing/images/logo.png" alt="image"></a>
...
<?php  } ?>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownSetting" style="float:right;">
          ...
          <a class="dropdown-item" href="<?=base_url()?>/Home/previewWindowUg">View My Profile</a>
          <div class="dropdown-divider"></div>
