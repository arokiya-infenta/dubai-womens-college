...
<html>
<head>
	<title>MSSW_PG Application</title>
...
echo"<h3>M.S.W (AIDED)</h3>";
foreach ($msw_aided as $value => $key ) {  
  
    if(in_array($value, $arrt_2)){ 
        echo $key."<br>";
...
echo"<h3>M.S.W (Self Finance)</h3>";
foreach ($msw_self_finance as $value => $key) {  
  
  
    if(in_array($value, $arrt_3)){ 
        echo $key."<br>";
