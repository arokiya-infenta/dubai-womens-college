        ...
        <div class="container">
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <h2 class="thank">Congratulations. You have completed the Entrance Test Successfully. Results will be published after reviewing your video on the date given in the prospectus and website. Keep checking the website for further updates on Interview and Selection Lists.</h2>  <h2 class="thank">Thank you</h2>
              </div>
            </div>
            <div class="row addme">
                <div class="once">
