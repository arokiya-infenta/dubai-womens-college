...
<html>
<head>
	<title>MSSW_UG Application</title>
        ...
        <h2><i class="fa fa-user" aria-hidden="true"></i> Educational Details</h2>
             ...
             <table class="table" id="myTable">
                 <tr>
                     ...
                     <td><?=$user[0]->pr_sslc_school?></td>
                 </tr>
                 <tr>
                     <th>Year of Passing </th>
                     <td><?=$user[0]->pr_sslc_year_of_passing?></td>
                 </tr>  <tr>
                     <th>Medium of Instruction</th>
                     <td><?=$user[0]->pr_sslc_medium_of_inst?></td>
                 </tr>  <tr>
                     <th>Language under Part II</th>
                     <td><?=$user[0]->pr_sslc_lang_under_2?></td>
                 </tr>
             </table>
...
<table class="table" id="myTable">
    <tr>
        <th>Name of the School</th>
        <td><?=$user[0]->pr_plus2_school?></td>
    </tr>
    <tr>
        <th>Year of Passing </th>
        <td><?=$user[0]->pr_plus2_year_of_passing?></td>
    </tr>  <tr>
        <th>Medium of Instruction</th>
        <td><?=$user[0]->pr_plus2_medium_of_inst?></td>
    </tr>  
    <tr>
        <th>Language under Part II</th>
        <td><?=$user[0]->pr_plus2_lang_under_2?></td>
    </tr>

    <tr>
        <th>BOARD</th>

        <?php if($user[0]->pr_board_study == "Others"){ ?>

          <td><?=$user[0]->pr_bord_other?></td>
      <?php  }else{ ?>
        <td><?=$user[0]->pr_board_study?></td>
...
echo"<tr><th>SSLC Certificate</th><td>Not Uploaded</td></tr>";
                         }else{
     echo"<tr><th>SSLC</th><td><a target='_blank' href='".base_url()."Home/UploadFile?file=".urlencode($user[0]->pr_sslc_mark)."'>Download</a></td></tr>";
                         }  ?>

<?php  if($user[0]->pr_hse2_certificate =="" || $user[0]->pr_hse2_certificate ==Null){
echo"<tr><th>+2 Certificate</th><td>Not Uploaded</td></tr>";
                         }else{
     echo"<tr><th>+2 Certificate</th><td><a target='_blank' href='".base_url()."Home/UploadFile?file=".urlencode($user[0]->pr_hse2_certificate)."'>Download</a></td></tr>";
                         }  ?>
                            <?php  if($user[0]->pr_provisional_mark_sheet =="" || $user[0]->pr_provisional_mark_sheet ==Null){
echo"<tr><th>+2 Provisional Mark Sheet</th><td>Not Uploaded</td></tr>";
                         }else{
...
echo"<tr><th>Transfer Certificate</th><td>Not Uploaded</td></tr>";
     ...
     echo"<tr><th>Transfer Certificate</th><td><a target='_blank' href='".base_url()."Home/UploadFile?file=".urlencode($user[0]->pr_transfer_cert)."'>Download</a></td></tr>";
                            ...
                            <?php  if($user[0]->pr_sepr_conduct_certificatemester_6 =="" || $user[0]->pr_conduct_certificate ==Null){
...
echo"<tr><th>Differently Abled</th><td>Not Uploaded</td></tr>";
                         }else{
     echo"<tr><th>Differently Abled</th><td><a target='_blank' href='".base_url()."Home/UploadFile?file=".urlencode($user[0]->pr_abled_certificate)."'>Download</a></td></tr>";
                         }  ?>
  ...
  if($user[0]->pr_other_res == "No"){ ?>
    ...
    <tr>
        ...
        <td><?=$Study[0]->lang_1_max_mark?></td>
        <td><?=$Study[0]->lang_1_obt_mark?></td>
      
      
      </tr>
          <tr>
        <td><?=$Study[0]->lang_2?></td>
        <td><?=$Study[0]->lang_2_max_mark?></td>
        <td><?=$Study[0]->lang_2_obt_mark?></td>
     
      
      </tr>
      
    </tbody></table>
    <h3>+2 Main Subject Mark</h3>
           <?php 
