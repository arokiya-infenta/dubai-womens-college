...
//alert(start);
$.ajax({
                        url:"<?php echo base_url(); ?>Academics/getDayAttendence",
                        type:"POST",
                        data:{start:start},
...
$(".pr_ug_psy").click(function(){
var m =$('input[name="pr_ug_psy"]:checked').val();
