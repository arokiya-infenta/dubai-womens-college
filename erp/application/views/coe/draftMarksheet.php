	  ...
	  <!--Start Row-->
	   ...
	   <div class="row">
		...
		<?php $this->session->set_flashdata('form_err',''); ?>
          <div class="card">
		  <div class="card-header"><i class="fa fa-table"></i>Draft Mark Sheet</div>
            <div class="card-body">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
			...
			<input name="type" value="Draftmarksheet" type="hidden">
			</form>
			</div>
            <div class="card-body">
                ...
                <tbody>
					...
					?>
                      <tr>
						...
						<td>
						<a href="<?=base_url().'coe/draftMarksheetPDF/'.$student->id.'/'.$sem1.'/'.$batch1?>">
