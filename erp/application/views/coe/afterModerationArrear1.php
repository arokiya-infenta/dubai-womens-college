            ...
            <div class="card-body">
              ...
              <table id="aftermodarr-datatable" class="table table-bordered">
                ...
                <tbody>
					...
					if($stream == 5){
						if($icamrk >= 20 && $mark >= 20){$result = '<span style="color:green;font-weight:bold;" data-student="'.$student->id.'">P</span>';}
						else{
							if($icamrk >= 20 && $mark < 20){$result = '<span style="color:red" data-student="'.$student->id.'">R(E)</span>';}
							elseif($icamrk < 20 && $mark >= 20){$result = '<span style="color:red" data-student="'.$student->id.'">R(I)</span>';}
							else{$result = '<span style="color:red" data-student="'.$student->id.'">R(I + E)</span>';}
								}
					}else{
						if($icamrk >= 25 && $mark >= 25){$result = '<span style="color:green;font-weight:bold;" data-student="'.$student->id.'">P</span>';}
						else{
							if($icamrk >= 25 && $mark < 25){$result = '<span style="color:red" data-student="'.$student->id.'">R(E)</span>';}
							elseif($icamrk < 25 && $mark >= 25){$result = '<span style="color:red" data-student="'.$student->id.'">R(I)</span>';}
							else{$result = '<span style="color:red" data-student="'.$student->id.'">R(I + E)</span>';}
								}
					}
					?>
