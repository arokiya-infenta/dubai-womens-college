...
<?php } ?>
		...
		<tr>
		 ...
		 <?php }} ?>
			...
			<tr>
			<td><?=ConverToRoman($sem)?></td>
			<td><?=$final_res1?><br\><?php if($part1!=0){echo number_format($part1,1);}?></td>
			<td><?=$final_res2?><br\><?php if($part2!=0){echo number_format($part2,1);}?></td>
			<td><?=$final_res3?><br\><?php if($part3!=0){echo number_format($part3,1);}?></td>
			<td><?=$final_res4?><br\><?php if($part4!=0){echo number_format($part4,1);}?></td>
			<td>NA</td>
			</tr>
			</table>
			<?php } ?>
