	  ...
	  <!--Start Row-->
	   ...
	   <div class="row">
		...
		<?php $this->session->set_flashdata('form_err',''); ?>
          <div class="card">
		  <div class="card-header"><i class="fa fa-table"></i>Final Mark Sheet</div>
            <div class="card-body">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
			...
			<form action="<?=base_url()?>coe/downloadMarksheetBulk" method="post">
			<button type="submit" class="btn btn-sm btn-success" id="bulkDownload">Bulk Download</button>
			<input name="sem" value="<?=$sem1?>" type="hidden">
			<input name="batch" value="<?=$batch1?>" type="hidden">
			<input name="stream" value="<?=$stream?>" type="hidden">
			<input name="department" value="<?=$department?>" type="hidden">
			<input name="type" value="Finalmarksheet" type="hidden">
			</form>
			</div>
            <div class="card-body">
                ...
                <tbody>
					...
					?>
                      <tr>
						...
						<td>
						<a href="<?=base_url().'coe/finalMarksheetPDF/'.$student->id.'/'.$sem1.'/'.$batch1?>" class="bulkDwn" data-student="<?=$student->id?>">
