...
<?php } ?>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header titlehms"><i class="fa fa-hand-o-right"></i>Payments Report</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
...
<div class="table-responsive">
 <table id="payments-report" class="table table-striped table-bordered table-hover">
  <thead>
  <tr>
                        <th>S.No </th>
                        <th>Name</th>
      ...
      <?php $sno=1;
					...
					?>
                      <tr>
						...
						<?php if($student->installment1==1){$check='Paid';}else{$check='Not Paid';}?>
                        <td><?=$check?></td>
						<?php if($student->installment2==1){$check1='Paid';}else{$check1='Not Paid';}?>
                        <td><?=$check1?></td>
                    </tr>
                    <?php } ?>
    </tbody>
...
var year_a = '<?=$year1?>';	
 var dept_a = $('#dept').val();		
var myTable = $('#payments-report'). DataTable( { 
		"bSortCellsTop": true,
			dom: 'Bfrtip', 
			buttons: 
			[{ 
				...
				filename: ''+batch_a+'_'+year_a+'_ '+currentDate+'',
				   ...
				   var rowCount = doc.content[1].table.body.length;
					...
					doc.content.splice(1, 1, {
                        ...
                        text: [  {text: 'DEPARTMENT: \t'+dept_a+'', bold: true, fontSize: 10, margin: 30}
                                    ...
                                    , {text: '\n YEAR:  \t\t\t\t\t'+year_a+'', bold: true, fontSize: 10, margin: 30}
                                        ],
                    });
