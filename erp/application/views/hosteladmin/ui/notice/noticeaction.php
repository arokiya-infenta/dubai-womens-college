        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form name="notic" action="<?=base_url()?>hosteladminlogin/updateNotice"  accept-charset="utf-8" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder="Notice Title" class="form-control" name="title" value="<?php echo $data[0];?>" required>
													<input type="hidden" name="edit_id" value="<?php echo $data[2];?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
