        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form name="fees" action="<?=base_url()?>hosteladminlogin/updateRoom"  accept-charset="utf-8" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder="Room No" class="form-control" name="roomNo" value="<?php echo $data[0];?>" required>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder="No Of Seat" class="form-control" name="noOfSeat" value="<?php echo $data[1];?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
