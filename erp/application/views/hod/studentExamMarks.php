 ...
 */
	  ...
	  if($closing_date->status == 1){ $avail = 1; } else { $avail = 2; }
		  } else { $avail = 3; }
		  ...
		  if($avail == 1 || $avail == 3){
			  $coe_stat = $this->db->where('batch',$batch1)->where('subject_id',$subject1)->get('erp_ica_to_coe')->row();
