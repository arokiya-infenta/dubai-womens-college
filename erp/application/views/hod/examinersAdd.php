	 ...
	 <div class="row">
		...
		<?php $this->session->set_flashdata('form_err',''); ?>
          <div class="card">
			...
			<div class="col-lg-3">
			<label>Batch</label>   
			<select class="form-control" name="batch" id="batch"  value="<?=set_value('batch')?>">
			...
			<label>Semester</label>   
			  <select class="form-control" id="sem" name="sem"  value="<?=set_value('sem')?>">
			...
			<label>Subject</label>   
			  <select class="form-control" id="subject" name="subject"  value="<?=set_value('subject')?>">
