      ...
      <div class="row mt-3">
        <div class="col-12">
			...
			<div class="row mt-5">
				...
				<input type="text" class="form-control iqac_textbox" placeholder="Event Name" name="event_name" value="<?=$iqac->event_name?>">
              </div>
            </div>
			...
			<div class="row mt-5">
				...
				<br/>
				<input type="radio" class="iqac_radio" name="funded_by" value="UGC" <?php if($iqac->funded_by == 'UGC'){echo 'checked';}?>> UGC 
				&nbsp;&nbsp;<input type="radio" class="iqac_radio" name="funded_by" value="Central Government" <?php if($iqac->funded_by == 'Central Government'){echo 'checked';}?>> Central Government
				&nbsp;&nbsp;<input type="radio" class="iqac_radio" name="funded_by" value="State Government" <?php if($iqac->funded_by == 'State Government'){echo 'checked';}?>> State Government
				&nbsp;&nbsp;<input type="radio" class="iqac_radio" name="funded_by" value="MSSW" <?php if($iqac->funded_by == 'MSSW'){echo 'checked';}?>> MSSW
				&nbsp;&nbsp;<input type="radio" class="iqac_radio" name="funded_by" value="Others" <?php if($iqac->funded_by == 'Others'){echo 'checked';}?>> Others
				</div>
				<div class="col-3 mt-3">
				<input type="text" class="form-control iqac_textbox" style="margin-top: 21px;margin-left: -131px;" placeholder="Mention if there are others" name="funded_by_other" value="<?=$iqac->funded_by_other?>"> 
			...
			<div class="row mt-5">
				...
				<input type="radio" class="iqac_radio" name="event_venue" value="MSSW Auditorium" <?php if($iqac->event_venue == 'MSSW Auditorium'){echo 'checked';}?>> MSSW Auditorium
				&nbsp;&nbsp;<input type="radio" class="iqac_radio" name="event_venue" value="MSSW Conference Hall" <?php if($iqac->event_venue == 'MSSW Conference Hall'){echo 'checked';}?>> MSSW Conference Hall
				&nbsp;&nbsp;<input type="radio" class="iqac_radio" name="event_venue" value="MSSW Video Conferencing Hall" <?php if($iqac->event_venue == 'MSSW Video Conferencing Hall'){echo 'checked';}?>> MSSW Video Conferencing Hall
				&nbsp;&nbsp;<input type="radio" class="iqac_radio" name="event_venue" value="MSSW Mini Conference Hall" <?php if($iqac->event_venue == 'MSSW Mini Conference Hall'){echo 'checked';}?>> MSSW Mini Conference Hall
				&nbsp;&nbsp;<input type="radio" class="iqac_radio" name="event_venue" value="Department" <?php if($iqac->event_venue == 'Department'){echo 'checked';}?>> Department
				&nbsp;&nbsp;<input type="radio" class="iqac_radio" name="event_venue" value="Class Room" <?php if($iqac->event_venue == 'Class Room'){echo 'checked';}?>> Class Room
				</div>
				<div class="col-1 mt-2">
				<input type="radio" class="iqac_radio" name="event_venue" value="Others" <?php if($iqac->event_venue == 'Others'){echo 'checked';}?>> Others
				</div>
				<div class="col-4 mt-2">
				<input type="text" class="form-control iqac_textbox" placeholder="Mention if there are others" name="event_venue_other" value="<?=$iqac->event_venue_other?>"> 
              </div>
            </div>
			...
			<div class="col-12 mt-3">
                ...
                <div class="col-4">
				<input type="text" class="form-control iqac_textbox" placeholder="Guest Name" name="resource_name" value="<?=$iqac->resource_name?>">
				</div>
				<div class="col-4">
				<input type="text" class="form-control iqac_textbox" placeholder="Guest Designation" name="resource_desig" value="<?=$iqac->resource_desig?>">
				</div>
				<div class="col-4">
				<input type="text" class="form-control iqac_textbox" placeholder="Guest Organization" name="resource_org" value="<?=$iqac->resource_org?>">
              </div>
            </div>
			...
			<div class="row mt-5">
                ...
                <div class="col-4">
				<input type="number" class="form-control iqac_textbox" placeholder="Mention Numbers" name="dept_seed" value="<?=$iqac->dept_seed?>">
              </div>
            </div>
			...
			<div class="row mt-5">
				...
				<input type="number" class="form-control iqac_textbox" placeholder="Mention Numbers" name="faculty_seed" value="<?=$iqac->faculty_seed?>">
              </div>
            </div>
			...
			<div class="row mt-5">
                ...
                <div class="col-4">
				<input type="text" class="form-control iqac_textbox" placeholder="Head/Coordinator Name" name="head_name" value="<?=$iqac->head_name?>">
              </div>
            </div>
			...
			<div class="row mt-5">
				...
				<input type="text" class="form-control iqac_textbox" placeholder="Faculty Name" name="secretary_name" value="<?=$iqac->secretary_name?>">
              </div>
            </div>
			...
			<div class="row mt-5">
				...
				<input type="text" class="form-control iqac_textbox" placeholder="Staff Name" name="staff_name" value="<?=$iqac->staff_name?>">
              </div>
            </div>
			...
			<div class="row mt-5">
				...
				<input type="checkbox" class="iqac_checkbox" name="consulted[]" value="hod" <?php if(in_array('hod',$consulted)){echo 'checked';}?>> HOD
				&nbsp;&nbsp;<input type="checkbox" class="iqac_checkbox" name="consulted[]" value="principal" <?php if(in_array('principal',$consulted)){echo 'checked';}?>> Principal
              </div>
            </div>
			...
			<div class="row mt-5">
			  ...
			  if($getrep->path != ''){
				...
				?>
               <a href="<?=base_url().$getrep->path?>" style="color:blue;cursor:pointer;" download><li><?=$report?><span class="close" data-id="<?=$getrep->id?>">&times;</span></li></a>
			  <?php }} ?>
               </ul>
              </div>
            </div>
			...
			<div class="row mt-5">
			  ...
			  if($getpho->path != ''){
				...
				?>
               <a href="<?=base_url().$getpho->path?>" style="color:blue;cursor:pointer;" download><li><?=$photo?><span class="close" data-id="<?=$getpho->id?>">&times;</span></li></a>
			  <?php }} ?>
               </ul>
              </div>
            </div>
			...
			<div class="row mt-5">
			  ...
			  if($getvid->path != ''){
				...
				?>
               <a href="<?=base_url().$getvid->path?>" style="color:blue;cursor:pointer;" download><li><?=$video?><span class="close" data-id="<?=$getvid->id?>">&times;</span></li></a>
			  <?php }} ?>
               </ul>
              </div>
            </div>
			...
			<div class="row mt-5">
			  ...
			  if($getdoc->path != ''){
				...
				?>
               <a href="<?=base_url().$getdoc->path?>" style="color:blue;cursor:pointer;" download><li><?=$document?><span class="close" data-id="<?=$getdoc->id?>">&times;</span></li></a>
			  <?php }} ?>
               </ul>
              </div>
            </div>
   ...
   <div class="row mt-3">
        <div class="col-12">
			...
			<div class="row mt-5">
                ...
                <div class="col-4">
				<input type="text" class="form-control iqac_textbox" placeholder="Faculty Name" name="fac_name" value="<?=$iqac->fac_name?>">
				</div>
                <div class="col-4">
				<input type="text" class="form-control iqac_textbox" placeholder="Faculty Designation" name="fac_designation" value="<?=$iqac->fac_designation?>">
				</div>
                <div class="col-4">
				<input type="text" class="form-control iqac_textbox" placeholder="Faculty Experience" name="fac_experience" value="<?=$iqac->fac_experience?>">
              </div>
            </div>
			...
			<div class="row mt-5">
                ...
                <div class="col-4">
				<input type="number" class="form-control iqac_textbox" placeholder="Mention Numbers" name="resource_no" value="<?=$iqac->resource_no?>">
              </div>
            </div>
			...
			<div class="row mt-5">
                ...
                <div class="col-4">
				<input type="number" class="form-control iqac_textbox" placeholder="Mention Numbers" name="final_stu_appeared" value="<?=$iqac->final_stu_appeared?>">
              </div>
            </div>
			...
			<div class="row mt-5">
                ...
                <div class="col-4">
				<input type="number" class="form-control iqac_textbox" placeholder="Mention Numbers" name="final_stu_passed" value="<?=$iqac->final_stu_passed?>">
              </div>
            </div>
			...
			<div class="row mt-5">
                ...
                <div class="col-4">
				<input type="number" class="form-control iqac_textbox" placeholder="Mention Numbers" name="stu_placed_no" value="<?=$iqac->stu_placed_no?>">
              </div>
            </div>
			...
			<div class="row mt-5">
                ...
                <div class="col-4">
				<input type="number" class="form-control iqac_textbox" placeholder="Mention Numbers" name="higher_studies_no" value="<?=$iqac->higher_studies_no?>">
              </div>
            </div>
			...
			<div class="row mt-5">
				...
				<input type="text" class="form-control iqac_textbox" placeholder="Mention Ratio" name="mentor_ratio" value="<?=$iqac->mentor_ratio?>">
              </div>
            </div>
...
$('.close').click(function(){
	...
	if (confirm('Are you sure to delete?')) {
            $.ajax({
                url: base_url + "employee/iqacUpdateDoc",
                type: 'POST',
                cache: false,
				//dataType: "html",
                data: {
