...
<head>
  ...
  <!--favicon-->
  <link rel="icon" href="https://admission.mssw.in/admin/white-version/image/th.ico" type="image/x-icon">
  <!-- Vector CSS -->
  ...
  <!--Select Plugins-->
  <link href="<?php echo base_url('').'white-version/assets/plugins/select2/css/select2.min.css'; ?>" rel="stylesheet" />
  <!--multi select-->
  <link href="<?php echo base_url('').'white-version/assets/plugins/jquery-multi-select/multi-select.css'; ?>" rel="stylesheet" type="text/css">
