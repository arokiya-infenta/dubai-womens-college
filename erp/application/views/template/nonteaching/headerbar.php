...
<header class="topbar-nav">
 <nav class="navbar navbar-expand fixed-top bg-white">
  <ul class="navbar-nav mr-auto align-items-center">
    ...
    $emp = $this->db->where('id',$user_id)->get('erp_employee_master')->row();
	$profile = $emp->emp_profile_;
	if($profile!=''){
		$user_prof = base_url().$profile;
	}else{
		$user_prof = 'https://via.placeholder.com/110x110';
	}
   ...
   <!-- <li class="nav-item language">
    ...
    <li class="nav-item">
      <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="#">
        <span class="user-profile"><img src="<?=$user_prof?>" class="img-circle" alt="user avatar"></span>
      </a>
      <ul class="dropdown-menu dropdown-menu-right">
