...
<header class="topbar-nav">
 <nav class="navbar navbar-expand fixed-top bg-white">
  ...
  echo "";
      ...
      redirect('Examiner_login/logOut', 'refresh'); 
   ...
   <!-- <li class="nav-item language">
    ...
    <li class="nav-item">
       ...
       <li class="dropdown-item user-details">
        <a href="javaScript:void();">
           <div class="media">
            ...
            <div class="media-body">
            <h6 class="mt-2 user-title"><?=$this->session->userdata('user')['user_firstname']?></h6>
      ...
      <!--  <li class="dropdown-divider"></li>
        ...
        <li class="dropdown-divider"></li>
        <li class="dropdown-item"><i class="icon-power mr-2"></i><a href="<?=base_url()?>Examiner_login/logOut"> Logout</a></li>
      </ul>
    </li>
  </ul>
</nav>
