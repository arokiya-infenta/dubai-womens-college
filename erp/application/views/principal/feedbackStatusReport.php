	  ...
	  <!--Start Row-->
	   ...
	   <div class="row">
		...
		<?php $this->session->set_flashdata('form_err',''); ?>
          <div class="card">
		  <div class="card-header"><i class="fa fa-table"></i>Feedback Status Report</div>
            <div class="card-body">
              ...
              <table id="feedback-status" class="table table-bordered">
                ...
                <tbody>
					...
					foreach ($stu_list as $student) {
						$feedback = $this->db->where('fr_stud_ad_id',$student->student_id)->where('fr_batch',$batch1)->where('fr_sem',$sem1)->where('fr_subject_id',$subject1)->get('feedback_course_report')->row();
						if(isset($feedback)){$stat = '<span style="color:green">Submitted</span>'; }else{ $stat = '<span style="color:red">Not Submitted</span>';}
					?>
                      <tr>
                        <td><?=$sno++?></td>
				...
				customize: function (doc) {
				   ...
				   var rowCount = doc.content[1].table.body.length;
                    ...
                    doc.content.splice(2, 0, {
                        ...
                        bold: true,
                        fontSize: 10,
                        text: [ {text: 'Feedback Not Submitted Report, As on '+currentDate+'', bold: true, fontSize: 10, margin: 30} ],
                    });
