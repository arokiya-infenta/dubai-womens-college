...
<body bgcolor="white">
<div>
<img src="<?=base_url()?>alumniassets/image/home_header.jpg" width="100%" height="200px" />
</div>
<table class="table">
<tr>
<td>
<ul class="ul1">
	<div class="dropdown">
	<li class="li_image"><img src="<?=base_url()?>alumniassets/image/WE23.png" width="55px" height="50px" style="padding-right:15px" /></li>
    </div>
    <div class="dropdown">
...
<button id="index_totop" onclick="topFunction()"><img src="<?=base_url()?>alumniassets/image/top.jpg" width="50px" height="50px"/></button>
