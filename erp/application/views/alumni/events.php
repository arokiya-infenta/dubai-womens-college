					...
					<li>
						...
						<div class="info">
							...
							<ul>
								...
								<li style="width:25%;"><a type="submit" href="<?=base_url().'alumnilogin/deleteEvent/'.$row->e_id?>" onclick="return confirm('Are you sure you want to delete?');"> Delete Event </a> </li>
							</ul>
						</div>
