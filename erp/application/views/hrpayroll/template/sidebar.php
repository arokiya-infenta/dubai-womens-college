        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile">
                    <!-- User profile image -->
                    <!--<div class="profile-img"> <img src="<?php echo base_url(); ?>hrassets/images/users/<?php echo $basicinfo->em_image ?>" alt="user" />-->
                    ...
                    <div class="profile-text">
                        <h5><?php echo $basicinfo->emp_name_; ?></h5>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <!--<li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-building-o"></i><span class="hide-menu">Organization </span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url();?>hrpayroll/organization/Department">Department </a></li>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Employees </span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="<?php echo base_url(); ?>hrpayroll/employee/Disciplinary">Disciplinary </a></li>
                                <li><a href="<?php echo base_url(); ?>hrpayroll/employee/Inactive_Employee">Inactive User </a></li>
                            </ul>
                        </li>-->
