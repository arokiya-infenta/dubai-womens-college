<?php $this->load->view('hrpayroll/template/header'); ?>
<?php $this->load->view('hrpayroll/template/sidebar'); ?>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        <h3 class="m-b-0">
                                    <?php 
                                        $this->db->where('emp_working_status_','Working');
                                        $this->db->from("erp_employee_master");
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="new-todo">
                                   <form method="post" action="<?= base_url().'hrpayroll/dashboard/add_todo'?>" enctype="multipart/form-data" id="add_todo" >
                                    <div class="input-group">
                                        <input type="text" name="todo_data" class="form-control" style="border: 1px solid #fff !IMPORTANT;" placeholder="Add new task">
                                        <span class="input-group-btn">
                                        <input type="hidden" name="userid" value="<?php echo $this->session->userdata('user')['user_id']; ?>">
                                        <button type="submit" class="btn btn-success todo-submit" name="submit"><i class="fa fa-plus"></i></button>
                                        </span> 
                                    </div>
                                    </form>
                                </div>                                
...
<?php $this->load->view('hrpayroll/template/footer'); ?>