                ...
                <div class="row">
                    <div class="col-lg-5">
                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                    <form method="post" action="<?php echo base_url();?>hrpayroll/organization/Update_dep" enctype="multipart/form-data">
                                        <div class="form-body">
                                            <div class="row ">
                                                <div class="col-md-12">
                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                    <form method="post" action="<?=base_url().'hrpayroll/organization/Save_dep'?>" enctype="multipart/form-data">
                                        <div class="form-body">
                                            <div class="row ">
                                                <div class="col-md-12">
                                                    <div class="form-group">
