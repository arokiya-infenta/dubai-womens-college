	 ...
	 <div class="row">
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-body">
			<form action="<?=base_url().'subadmin/IDGenerate1'?>" method="post">
              <div class="row">
			  <div class="col-lg-3">
			  ...
			  <?php if(isset($programm)){if(sizeof($programm)>0){foreach($programm as $programm){ ?>
          ...
          <div class="card">
			...
			<div class="row">
			  <div class="col-lg-12">
				...
				<button id="idgenerate1" class="btn btn-sm btn-success" name="gen_id">Generate ID</button>
				</div>
			  </div>
			</div>
			</div>
