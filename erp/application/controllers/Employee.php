...
class Employee extends CI_Controller {
	...
	//  error_reporting(0);
	  ...
	  $this->load->config('email');
		...
		$det = $this->db->where('id',$this->session->userdata('user')['user_id'])->get('erp_employee_master')->row();
		$this->mystream = $det->emp_college_type_;
		$this->mydepart = $det->emp_dept_name_;
    ...
    $this->load->view('template/employee/header');
    $this->load->view('template/employee/menubar');
    $this->load->view('template/employee/headerbar');
    $this->load->view('employee/dashbord',$data);
    $this->load->view('template/employee/footer');
    }
		...
		if(isset($_POST['submit'])){
		 ...
		 if(isset($get_pwd)){
			 if($new==$confirm){
				 ...
				 redirect('employee/updatePassword','refresh');
			 }else{
    ...
    $this->load->view('template/employee/menubar');
    $this->load->view('template/employee/headerbar');
    $this->load->view('employee/update_password',$data);
    $this->load->view('template/employee/footer');
    }
    ...
    $this->load->view('template/employee/menubar');
    $this->load->view('template/employee/headerbar');
    $this->load->view('employee/student_attendance1',$data);
    $this->load->view('template/employee/footer');
    }
    ...
    if($get_sub->subCatg == 'Elective'){
		
					$this->db->join('erp_student_elective_subject','erp_student_elective_subject.e_admit_stu_id=erp_existing_students.id');
    ...
    $this->load->view('template/employee/menubar');
    $this->load->view('template/employee/headerbar');
    $this->load->view('employee/student_attendance',$data);
    $this->load->view('template/employee/footer');
    }
	...
	/*$date=str_replace('-','/','2023-03-16');
	$add_date=date('Y-m-d',strtotime($date));
	$sem=2;
	$subject=384;
	$period=1;
	$id_present=array('2840-1','2841-1','2842-1','2843-1','2844-1','2845-1','2846-1','2847-1','2839-1','2848-1','2849-1','2850-1','2851-1','2852-1','2853-1');
	$id_absent=array();
	$id_od=array();*/
	...
	foreach ( $row as $row ) {
		...
		if ( $row["leave_status_principal"] == 'pending' ) {
			$nestedData[] = '<span class="label label-warning">' . ucwords($row["leave_status_principal"]) . '</span>';
		} elseif ( $row['leave_status_principal'] == 'approve' ) {
			$nestedData[] = '<span class="label label-success">' . ucwords($row["leave_status_principal"]) . 'd</span>';
		} elseif ( $row['leave_status_principal'] == 'reject' ) {
			$nestedData[] = '<span class="label label-danger">' . ucwords($row["leave_status_principal"]) . 'ed</span>';
		}
		$data[] = $nestedData;
		$i++;
		$sno++;
...
function ApplyLeaveToAdminApproval() {
	...
	public function allocateSubject()
    {
	  ...
	  $data['department']=$department=$this->input->post('department');	
	   ...
	   redirect('employee/allocateSubject','refresh');
		}
		
	$this->load->view('template/employee/header');
    $this->load->view('template/employee/menubar');
    $this->load->view('template/employee/headerbar');
    $this->load->view('employee/allocate_subject',$data);
    $this->load->view('template/employee/footer');
    }
...
public function studentExamMarks()
	{
        ...
        if($get_sub->subCatg == 'Elective'){
					...
					$this->db->join('erp_student_elective_subject','erp_student_elective_subject.e_admit_stu_id=erp_existing_students.id');
		$this->db->where('erp_student_elective_subject.e_subject',$subject);
		$this->db->where('erp_student_elective_subject.e_sem',$sem);
		$this->db->where('erp_student_elective_subject.e_batch',$batch);
    ...
    $this->load->view('template/employee/menubar');
    $this->load->view('template/employee/headerbar');
    $this->load->view('employee/studentExamMarks',$data);
    $this->load->view('template/employee/footer');	
	}
	...
	$stu_id = $this->db->where('id',$ica1_not[$ii])->get('erp_existing_students')->row();
	$get_sub1=$this->db->where('subCode',$get_sub->subCode)->where('stream',$stu_id->main_id)->where('department',$stu_id->cour_id)->where('batch_year',$batch)->get('erp_subjectmaster')->row();
	$subject_id=$get_sub1->id;
	...
	$stu_id = $this->db->where('id',$ica2_not[$ii])->get('erp_existing_students')->row();
	$get_sub1=$this->db->where('subCode',$get_sub->subCode)->where('stream',$stu_id->main_id)->where('department',$stu_id->cour_id)->where('batch_year',$batch)->get('erp_subjectmaster')->row();
	$subject_id=$get_sub1->id;
	...
	$stu_id = $this->db->where('id',$inclass_not[$ii])->get('erp_existing_students')->row();
	$get_sub1=$this->db->where('subCode',$get_sub->subCode)->where('stream',$stu_id->main_id)->where('department',$stu_id->cour_id)->where('batch_year',$batch)->get('erp_subjectmaster')->row();
	$subject_id=$get_sub1->id;
	...
	$stu_id = $this->db->where('id',$takehome_not[$ii])->get('erp_existing_students')->row();
	$get_sub1=$this->db->where('subCode',$get_sub->subCode)->where('stream',$stu_id->main_id)->where('department',$stu_id->cour_id)->where('batch_year',$batch)->get('erp_subjectmaster')->row();
	$subject_id=$get_sub1->id;
    ...
    $this->load->view('template/employee/menubar');
    $this->load->view('template/employee/headerbar');
    $this->load->view('employee/attendance_report_monthwise',$data);
    $this->load->view('template/employee/footer');
    }
    ...
    $this->load->view('template/employee/menubar');
    $this->load->view('template/employee/headerbar');
    $this->load->view('employee/consolidated_report',$data);
    $this->load->view('template/employee/footer');
    }
...
$get_sub = $this->db->where('id',$subject)->get('erp_subjectmaster')->row();
    ...
    $this->load->view('template/employee/menubar');
    $this->load->view('template/employee/headerbar');
    $this->load->view('employee/icaReport',$data);
    $this->load->view('template/employee/footer');	
	}
	...
	public function icaReportPDF()
	{
		...
		->get('erp_existing_students')->result();
            ...
            $html = $this->load->view("employee/icaReportPDF", $data, true);
...
');
    ...
    $this->load->view('template/employee/menubar');
    $this->load->view('template/employee/headerbar');
    $this->load->view('employee/delete_attendance',$data);
    $this->load->view('template/employee/footer');	
	}
 ...
 */
	...
	//	$data['subject']=$this->db->select('s.id,s.subName')->join('erp_subjectmaster s','s.id=e.subject_id')->where('s.batch_year',$batch)->where('s.sem',$sem)->where('e.employee_id',$user_id)->where('s.part',5)->get('erp_employee_subject e')->result();
		...
		if($get_sub->stream==5){
			$data['subject']= $this->db->select('s.id,s.subName')->join('erp_subjectmaster s','s.id=e.subject_id')->where('s.batch_year',$batch)->where('s.sem',$sem)->where('e.employee_id',$user_id)->where('s.part',5)->get('erp_employee_subject e')->result();	
				...
				$data['subject'] = $this->db->select('s.id,s.subName')->join('erp_subjectmaster s','s.id=e.subject_id')->where('s.batch_year',$batch)->where('s.sem',$sem)->where('e.employee_id',$user_id)->where('(s.part=3 or s.part=5)')->get('erp_employee_subject e')->result();	
    ...
    $this->load->view('template/employee/menubar');
    $this->load->view('template/employee/headerbar');
    $this->load->view('employee/partvMarks',$data);
    $this->load->view('template/employee/footer');	
	}
    ...
    $this->load->view('template/employee/menubar');
    $this->load->view('template/employee/headerbar');
    $this->load->view('employee/partvMarksReport',$data);
    $this->load->view('template/employee/footer');	
	}
	...
	$sub = $this->db->select('s.id,s.subName')->join('erp_subjectmaster s','s.id=e.subject_id')->where('s.batch_year',$batch)->where('s.sem',$sem)->where('e.employee_id',$user_id)->where('s.part',5)->get('erp_employee_subject e')->result();	
		...
		$sub = $this->db->select('s.id,s.subName')->join('erp_subjectmaster s','s.id=e.subject_id')->where('s.batch_year',$batch)->where('s.sem',$sem)->where('e.employee_id',$user_id)->where('(s.part=3 or s.part=5)')->get('erp_employee_subject e')->result();	
...
//print_r($this->db->last_query());exit;
 ...
 $subject = '<option value="">Select Subject</option>';
    ...
    $this->load->view('template/employee/menubar');
    $this->load->view('template/employee/headerbar');
    $this->load->view('employee/iqac',$data);
    $this->load->view('template/employee/footer');
	}
	...
	redirect('employee/iqacForm','refresh');
		 }
		 
	$this->load->view('template/employee/header');
    $this->load->view('template/employee/menubar');
    $this->load->view('template/employee/headerbar');
    $this->load->view('employee/iqacForm',$data);
    $this->load->view('template/employee/footer');
	}	
	...
	$data['msg']=$this->session->set_flashdata('success','Uploaded Successfully','success');
	redirect('employee/iqacFormEdit/'.$id.'','refresh');
		 }
		 
	$this->load->view('template/employee/header');
    $this->load->view('template/employee/menubar');
    $this->load->view('template/employee/headerbar');
    $this->load->view('employee/iqacFormEdit',$data);
    $this->load->view('template/employee/footer');
	}
	...
	if(!(($part==1 OR $part==4) AND $stream==5)){
