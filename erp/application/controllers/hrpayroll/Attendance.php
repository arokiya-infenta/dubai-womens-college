...
class Attendance extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('hrpayroll/loan_model');
        $this->load->model('hrpayroll/settings_model');
        $this->load->model('hrpayroll/leave_model');
        $this->load->model('hrpayroll/attendance_model');
    ...
    public function Attendance()
    {
        if ($this->session->userdata('user_login_access') != False) {
            ...
            $this->load->view('hrpayroll/attendance', $data);
        } else {
    ...
    public function Save_Attendance()
    {
        if ($this->session->userdata('user_login_access') != False) {
            ...
            $this->load->view('hrpayroll/add_attendance', $data);
        } else {
            redirect(base_url(), 'refresh');
        }
    }
    ...
    public function Attendance_Report()
    {
        if ($this->session->userdata('user_login_access') != False) {
            ...
            $this->load->view('hrpayroll/attendance_report', $data);
        } else {
            redirect(base_url(), 'refresh');
        }
    }
