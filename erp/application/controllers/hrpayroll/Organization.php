...
class Organization extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->load->model('hrpayroll/organization_model');
    ...
    public function Department(){
        if($this->session->userdata('user')['user_id'] != False) { 
        $data['department'] = $this->organization_model->depselect();
        $this->load->view('hrpayroll/department',$data); 
        }
    else{
    ...
    public function Delete_dep($dep_id){
        ...
        redirect('hrpayroll/organization/Department');
        }
    else{
		redirect(base_url() , 'refresh');
	}            
    ...
    public function Designation(){
        ...
        $this->load->view('hrpayroll/designation',$data);
        }
    else{
		redirect(base_url() , 'refresh');
	}        
    ...
    public function des_delete($des_id){
        ...
        $this->session->set_flashdata('delsuccess', 'Successfully Deleted');
        redirect('hrpayroll/organization/Designation');
        }
    else{
		redirect(base_url() , 'refresh');
	}        
